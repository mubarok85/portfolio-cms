        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            ...
            <p className="mt-2 text-sm leading-6 text-slate-400">
              Create or update a service displayed on your portfolio.
            </p>
          </div>
        ...
        <div className="mt-8 grid gap-6 md:grid-cols-2">
          ...
          <div className="md:col-span-2">
            ...
            <textarea
              ...
              placeholder="Describe this professional service."
          ...
          <label className="flex cursor-pointer items-center gap-4 rounded-2xl border border-white/10 bg-black/20 p-5">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-slate-400">
                Display this service on the public website.
              </p>
            </div>
          </label>
        </div>
        ...
        <div className="flex items-center justify-between gap-4">
          <div>
            ...
            <p className="mt-2 text-sm text-slate-400">
              {services.length} service entries.
            </p>
          </div>
